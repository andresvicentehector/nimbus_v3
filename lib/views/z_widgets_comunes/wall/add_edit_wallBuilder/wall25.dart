          ...
          if (presas.contains('${int.parse(num25[index])},16777215') == true) {
            ...
            return Container(
                ...
                child: WallButton(
                  ...
                  presas: presas,
                  numero:
                      presas.indexOf('${int.parse(num25[index])},16777215') + 1,
                  c2: c2,
                  height: 32.3,
                ));
          }
          ...
          if (presas.contains('${int.parse(num25[index])},16711680') == true) {
            ...
            return Container(
                ...
                child: WallButton(
                  ...
                  presas: presas,
                  numero:
                      presas.indexOf('${int.parse(num25[index])},16711680') + 1,
                  c2: c2,
                  height: 32.3,
                ));
          }
          if (presas.contains('${int.parse(num25[index])},255') == true) {
            ...
            return Container(
                ...
                child: WallButton(
                  ...
                  sendMessage: sendMessage,
                  presas: presas,
                  numero: presas.indexOf('${int.parse(num25[index])},255') + 1,
                  c2: c2,
                  height: 32.3,
                ));
          }
          if (presas.contains('${int.parse(num25[index])},16776960') == true) {
            ...
            return Container(
                ...
                child: WallButton(
                  ...
                  presas: presas,
                  numero:
                      presas.indexOf('${int.parse(num25[index])},16776960') + 1,
                  c2: c2,
                  height: 32.3,
                ));
          }
