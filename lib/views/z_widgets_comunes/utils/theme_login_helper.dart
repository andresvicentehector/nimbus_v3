...
class ThemeLoginHelper {
  InputDecoration textInputDecoration(
    ...
    return InputDecoration(
      ...
      labelStyle: TextStyle(
          color: Colors.grey, fontFamily: context?.resources.fonts.tittle),
  ...
  BoxDecoration buttonBoxDecoration(BuildContext context,
    ...
    Color c2 = Theme.of(context).colorScheme.primary;
  ...
  BoxDecoration buttonBoxDecorationGoogle(BuildContext context,
      [String color1 = "", String color2 = ""]) {
    Color c1 = Theme.of(context).colorScheme.primary;
    Color c2 = Theme.of(context).colorScheme.primary;
    if (color1.isEmpty == false) {
